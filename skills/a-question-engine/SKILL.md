---
name: a-question-engine
description: Avengers skill A - Question Engine that helps the user to generate sharper questions that unlock technical or strategic progress. Use when the user mentions or needs one of these triggers - questions, ask better, inquiry. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Learning And Intelligence skill. Generate sharper questions that unlock technical or strategic progress.

## Use When

- The user needs to generate sharper questions that unlock technical or strategic progress.
- The request matches these triggers: questions, ask better, inquiry.
...
```text
Use $a-question-engine to create a build-first learning plan for this topic.
```
...
If the user asks for generate sharper questions that unlock technical or strategic progress., return the output contract fields and a concrete next action.
