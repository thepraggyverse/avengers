---
name: a-ultron-failure-review
description: Avengers skill A - Ultron Failure Review that helps the user to analyze how a good-intentioned system can create unintended harm. Use when the user mentions or needs one of these triggers - Ultron, unintended consequences, backfire. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Risk Ethics And Control skill. Analyze how a good-intentioned system can create unintended harm.

## Use When

- The user needs to analyze how a good-intentioned system can create unintended harm.
- The request matches these triggers: Ultron, unintended consequences, backfire.
...
```text
Use $a-ultron-failure-review to check whether this safety idea creates control risk.
```
...
If the user asks for analyze how a good-intentioned system can create unintended harm., return the output contract fields and a concrete next action.
