---
name: a-quality-control-reactor
description: Avengers skill A - Quality Control Reactor that helps the user to add quality checks that protect output without slowing everything. Use when the user mentions or needs one of these triggers - quality control, checks, review gate. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Lean Six Sigma Workflow skill. Add quality checks that protect output without slowing everything.

## Use When

- The user needs to add quality checks that protect output without slowing everything.
- The request matches these triggers: quality control, checks, review gate.
...
```text
Use $a-quality-control-reactor to improve this repeated workflow and reduce waste.
```
...
If the user asks for add quality checks that protect output without slowing everything., return the output contract fields and a concrete next action.
