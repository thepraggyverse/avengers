---
name: a-fear-to-motion
description: Avengers skill A - Fear To Motion that helps the user to turn fear into one visible action instead of rumination. Use when the user mentions or needs one of these triggers - fear, stuck, first brave action. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Confidence And Permission skill. Turn fear into one visible action instead of rumination.

## Use When

- The user needs to turn fear into one visible action instead of rumination.
- The request matches these triggers: fear, stuck, first brave action.
...
```text
Use $a-fear-to-motion because I am waiting for approval before acting.
```
...
If the user asks for turn fear into one visible action instead of rumination., return the output contract fields and a concrete next action.
