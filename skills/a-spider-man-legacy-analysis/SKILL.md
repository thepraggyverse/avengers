---
name: a-spider-man-legacy-analysis
description: Avengers skill A - Spider Man Legacy Analysis that helps the user to track Tony's legacy through Peter Parker and the Spider-Man films. Use when the user mentions or needs one of these triggers - Spider-Man legacy, Peter, Tony legacy. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 4 MCU Story Analysis skill. Track Tony's legacy through Peter Parker and the Spider-Man films.

## Use When

- The user needs to track Tony's legacy through Peter Parker and the Spider-Man films.
- The request matches these triggers: Spider-Man legacy, Peter, Tony legacy.
...
```text
Use $a-spider-man-legacy-analysis to break down this MCU scene or transcript theme.
```
...
If the user asks for track tony's legacy through peter parker and the spider-man films., return the output contract fields and a concrete next action.
