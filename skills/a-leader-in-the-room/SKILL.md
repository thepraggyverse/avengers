---
name: a-leader-in-the-room
description: Avengers skill A - Leader In The Room that helps the user to decide when to lead, defer, challenge, or support. Use when the user mentions or needs one of these triggers - should I lead, take charge, defer. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Leadership And Team skill. Decide when to lead, defer, challenge, or support.

## Use When

- The user needs to decide when to lead, defer, challenge, or support.
- The request matches these triggers: should I lead, take charge, defer.
...
```text
Use $a-leader-in-the-room to handle this team conflict without losing trust.
```
...
If the user asks for decide when to lead, defer, challenge, or support., return the output contract fields and a concrete next action.
