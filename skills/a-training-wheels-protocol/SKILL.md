---
name: a-training-wheels-protocol
description: Avengers skill A - Training Wheels Protocol that helps the user to decide how much support, monitoring, or independence to provide. Use when the user mentions or needs one of these triggers - training wheels, support, independence. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Mentorship And Peter Parker skill. Decide how much support, monitoring, or independence to provide.

## Use When

- The user needs to decide how much support, monitoring, or independence to provide.
...
If the user asks for decide how much support, monitoring, or independence to provide., return the output contract fields and a concrete next action.
