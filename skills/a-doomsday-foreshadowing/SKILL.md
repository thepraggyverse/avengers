---
name: a-doomsday-foreshadowing
description: Avengers skill A - Doomsday Foreshadowing that helps the user to extract possible Avengers Doomsday setup and theory hooks. Use when the user mentions or needs one of these triggers - Doomsday, foreshadowing, setup. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 4 MCU Story Analysis skill. Extract possible Avengers Doomsday setup and theory hooks.

## Use When

- The user needs to extract possible Avengers Doomsday setup and theory hooks.
...
If the user asks for extract possible avengers doomsday setup and theory hooks., return the output contract fields and a concrete next action.
