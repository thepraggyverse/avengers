---
name: a-constraints-as-design
description: Avengers skill A - Constraints As Design that helps the user to use constraints as design material instead of excuses. Use when the user mentions or needs one of these triggers - constraints as design, limitations, turn limits. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Resourcefulness skill. Use constraints as design material instead of excuses.

## Use When

- The user needs to use constraints as design material instead of excuses.
- The request matches these triggers: constraints as design, limitations, turn limits.
...
```text
Use $a-constraints-as-design to solve this with only the resources I already have.
```
...
If the user asks for use constraints as design material instead of excuses., return the output contract fields and a concrete next action.
