---
name: a-stark-obsessive-improvement
description: Avengers skill A - Stark Obsessive Improvement that helps the user to treat every output as a suit version that can be upgraded. Use when the user mentions or needs one of these triggers - continuous improvement, upgrade, iteration, better version. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Tony Stark Core skill. Treat every output as a suit version that can be upgraded.

## Use When

- The user needs to treat every output as a suit version that can be upgraded.
- The request matches these triggers: continuous improvement, upgrade, iteration, better version.
...
```text
Use $a-stark-obsessive-improvement to turn this vague objective into a practical Stark-style operating mode.
```
...
If the user asks for treat every output as a suit version that can be upgraded., return the output contract fields and a concrete next action.
