---
name: a-trust-repair-after-conflict
description: Avengers skill A - Trust Repair After Conflict that helps the user to rebuild working trust after a rupture or ideological split. Use when the user mentions or needs one of these triggers - repair trust, after conflict, team split. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Leadership And Team skill. Rebuild working trust after a rupture or ideological split.

## Use When

- The user needs to rebuild working trust after a rupture or ideological split.
...
If the user asks for rebuild working trust after a rupture or ideological split., return the output contract fields and a concrete next action.
