---
name: a-captain-america-leadership
description: Avengers skill A - Captain America Leadership that helps the user to lead through values, steadiness, courage, and service. Use when the user mentions or needs one of these triggers - Captain America leadership, lead like Cap. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Leadership And Team skill. Lead through values, steadiness, courage, and service.

## Use When

- The user needs to lead through values, steadiness, courage, and service.
- The request matches these triggers: Captain America leadership, lead like Cap.
...
```text
Use $a-captain-america-leadership to handle this team conflict without losing trust.
```
...
If the user asks for lead through values, steadiness, courage, and service., return the output contract fields and a concrete next action.
