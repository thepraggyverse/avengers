---
name: a-interface-inside-the-suit
description: Avengers skill A - Interface Inside The Suit that helps the user to design tools around the human operator, not the spectacle. Use when the user mentions or needs one of these triggers - interface, human inside suit, tool design. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Armor Tech Product Design skill. Design tools around the human operator, not the spectacle.

## Use When

- The user needs to design tools around the human operator, not the spectacle.
- The request matches these triggers: interface, human inside suit, tool design.
...
```text
Use $a-interface-inside-the-suit to review this tool as an armor system for a real operator.
```
...
If the user asks for design tools around the human operator, not the spectacle., return the output contract fields and a concrete next action.
