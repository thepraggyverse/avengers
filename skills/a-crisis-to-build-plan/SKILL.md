---
name: a-crisis-to-build-plan
description: Avengers skill A - Crisis To Build Plan that helps the user to turn a crisis into a small sequence of buildable actions. Use when the user mentions or needs one of these triggers - crisis, action plan, emergency, next steps. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Problem Solving skill. Turn a crisis into a small sequence of buildable actions.

## Use When

- The user needs to turn a crisis into a small sequence of buildable actions.
- The request matches these triggers: crisis, action plan, emergency, next steps.
...
```text
Use $a-crisis-to-build-plan on this messy situation and give me the next concrete move.
```
...
If the user asks for turn a crisis into a small sequence of buildable actions., return the output contract fields and a concrete next action.
