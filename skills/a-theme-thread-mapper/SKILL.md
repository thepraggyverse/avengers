---
name: a-theme-thread-mapper
description: Avengers skill A - Theme Thread Mapper that helps the user to track a theme across movies, scenes, and transcripts. Use when the user mentions or needs one of these triggers - theme thread, map theme, recurring idea. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 4 MCU Story Analysis skill. Track a theme across movies, scenes, and transcripts.

## Use When

- The user needs to track a theme across movies, scenes, and transcripts.
- The request matches these triggers: theme thread, map theme, recurring idea.
...
```text
Use $a-theme-thread-mapper to break down this MCU scene or transcript theme.
```
...
If the user asks for track a theme across movies, scenes, and transcripts., return the output contract fields and a concrete next action.
