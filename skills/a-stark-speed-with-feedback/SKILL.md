---
name: a-stark-speed-with-feedback
description: Avengers skill A - Stark Speed With Feedback that helps the user to move quickly while installing feedback, tests, and correction loops. Use when the user mentions or needs one of these triggers - fast iteration, feedback loop, move quickly, speed with safety. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Tony Stark Core skill. Move quickly while installing feedback, tests, and correction loops.

## Use When

- The user needs to move quickly while installing feedback, tests, and correction loops.
- The request matches these triggers: fast iteration, feedback loop, move quickly, speed with safety.
...
```text
Use $a-stark-speed-with-feedback to turn this vague objective into a practical Stark-style operating mode.
```
...
If the user asks for move quickly while installing feedback, tests, and correction loops., return the output contract fields and a concrete next action.
