---
name: a-burnout-safety-check
description: Avengers skill A - Burnout Safety Check that helps the user to detect overload and redesign the load before damage accumulates. Use when the user mentions or needs one of these triggers - burnout, overloaded, too much. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Multiple Projects skill. Detect overload and redesign the load before damage accumulates.

## Use When

- The user needs to detect overload and redesign the load before damage accumulates.
- The request matches these triggers: burnout, overloaded, too much.
...
```text
Use $a-burnout-safety-check to organize these active projects without burning out.
```
...
If the user asks for detect overload and redesign the load before damage accumulates., return the output contract fields and a concrete next action.
