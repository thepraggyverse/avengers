---
name: a-team-assembly-avengers
description: Avengers skill A - Team Assembly Avengers that helps the user to assemble roles, strengths, gaps, and team operating rules. Use when the user mentions or needs one of these triggers - assemble team, Avengers team, roles. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Leadership And Team skill. Assemble roles, strengths, gaps, and team operating rules.

## Use When

- The user needs to assemble roles, strengths, gaps, and team operating rules.
- The request matches these triggers: assemble team, Avengers team, roles.
...
```text
Use $a-team-assembly-avengers to handle this team conflict without losing trust.
```
...
If the user asks for assemble roles, strengths, gaps, and team operating rules., return the output contract fields and a concrete next action.
