---
name: a-accords-governance
description: Avengers skill A - Accords Governance that helps the user to design accountability, oversight, and autonomy rules. Use when the user mentions or needs one of these triggers - governance, accords, accountability. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Leadership And Team skill. Design accountability, oversight, and autonomy rules.

## Use When

- The user needs to design accountability, oversight, and autonomy rules.
- The request matches these triggers: governance, accords, accountability.
...
```text
Use $a-accords-governance to handle this team conflict without losing trust.
```
...
If the user asks for design accountability, oversight, and autonomy rules., return the output contract fields and a concrete next action.
