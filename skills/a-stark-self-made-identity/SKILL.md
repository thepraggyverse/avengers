---
name: a-stark-self-made-identity
description: Avengers skill A - Stark Self Made Identity that helps the user to convert identity from waiting to being the builder who acts. Use when the user mentions or needs one of these triggers - identity, become capable, self-made, act like builder. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Tony Stark Core skill. Convert identity from waiting to being the builder who acts.

## Use When

- The user needs to convert identity from waiting to being the builder who acts.
- The request matches these triggers: identity, become capable, self-made, act like builder.
...
```text
Use $a-stark-self-made-identity to turn this vague objective into a practical Stark-style operating mode.
```
...
If the user asks for convert identity from waiting to being the builder who acts., return the output contract fields and a concrete next action.
