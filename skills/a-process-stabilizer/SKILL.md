---
name: a-process-stabilizer
description: Avengers skill A - Process Stabilizer that helps the user to turn chaotic repeated work into a stable process. Use when the user mentions or needs one of these triggers - process, stabilize, repeatable. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Lean Six Sigma Workflow skill. Turn chaotic repeated work into a stable process.

## Use When

- The user needs to turn chaotic repeated work into a stable process.
- The request matches these triggers: process, stabilize, repeatable.
...
```text
Use $a-process-stabilizer to improve this repeated workflow and reduce waste.
```
...
If the user asks for turn chaotic repeated work into a stable process., return the output contract fields and a concrete next action.
