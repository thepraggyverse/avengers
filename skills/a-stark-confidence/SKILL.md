---
name: a-stark-confidence
description: Avengers skill A - Stark Confidence that helps the user to build grounded confidence from competence, proof, and decisive action. Use when the user mentions or needs one of these triggers - confidence, Tony confidence, self belief. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Confidence And Permission skill. Build grounded confidence from competence, proof, and decisive action.

## Use When

- The user needs to build grounded confidence from competence, proof, and decisive action.
- The request matches these triggers: confidence, Tony confidence, self belief.
...
```text
Use $a-stark-confidence because I am waiting for approval before acting.
```
...
If the user asks for build grounded confidence from competence, proof, and decisive action., return the output contract fields and a concrete next action.
