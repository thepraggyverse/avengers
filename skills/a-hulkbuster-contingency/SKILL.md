---
name: a-hulkbuster-contingency
description: Avengers skill A - Hulkbuster Contingency that helps the user to build a contingency for rare high-impact failure modes. Use when the user mentions or needs one of these triggers - Hulkbuster, contingency, emergency mode. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Armor Tech Product Design skill. Build a contingency for rare high-impact failure modes.

## Use When

- The user needs to build a contingency for rare high-impact failure modes.
- The request matches these triggers: Hulkbuster, contingency, emergency mode.
...
```text
Use $a-hulkbuster-contingency to review this tool as an armor system for a real operator.
```
...
If the user asks for build a contingency for rare high-impact failure modes., return the output contract fields and a concrete next action.
