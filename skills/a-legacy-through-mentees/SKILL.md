---
name: a-legacy-through-mentees
description: Avengers skill A - Legacy Through Mentees that helps the user to pass values, standards, and judgment through mentees. Use when the user mentions or needs one of these triggers - legacy, teach, mentee. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Mentorship And Peter Parker skill. Pass values, standards, and judgment through mentees.

## Use When

- The user needs to pass values, standards, and judgment through mentees.
- The request matches these triggers: legacy, teach, mentee.
...
```text
Use $a-legacy-through-mentees to mentor this junior builder without overcontrolling them.
```
...
If the user asks for pass values, standards, and judgment through mentees., return the output contract fields and a concrete next action.
