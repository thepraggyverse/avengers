---
name: a-curse-of-being-right
description: Avengers skill A - Curse Of Being Right that helps the user to handle being right early without becoming isolated or abrasive. Use when the user mentions or needs one of these triggers - curse of being right, I warned them. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Risk Ethics And Control skill. Handle being right early without becoming isolated or abrasive.

## Use When

- The user needs to handle being right early without becoming isolated or abrasive.
- The request matches these triggers: curse of being right, I warned them.
...
```text
Use $a-curse-of-being-right to check whether this safety idea creates control risk.
```
...
If the user asks for handle being right early without becoming isolated or abrasive., return the output contract fields and a concrete next action.
