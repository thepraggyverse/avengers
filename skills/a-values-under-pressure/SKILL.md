---
name: a-values-under-pressure
description: Avengers skill A - Values Under Pressure that helps the user to protect core values when pressure, fear, or speed rises. Use when the user mentions or needs one of these triggers - values, pressure, principles. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Leadership And Team skill. Protect core values when pressure, fear, or speed rises.

## Use When

- The user needs to protect core values when pressure, fear, or speed rises.
- The request matches these triggers: values, pressure, principles.
...
```text
Use $a-values-under-pressure to handle this team conflict without losing trust.
```
...
If the user asks for protect core values when pressure, fear, or speed rises., return the output contract fields and a concrete next action.
