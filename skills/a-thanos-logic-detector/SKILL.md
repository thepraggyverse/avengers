---
name: a-thanos-logic-detector
description: Avengers skill A - Thanos Logic Detector that helps the user to detect cold utilitarian reasoning that erases people. Use when the user mentions or needs one of these triggers - Thanos logic, ends justify means, utilitarian. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 3 Risk Ethics And Control skill. Detect cold utilitarian reasoning that erases people.

## Use When

- The user needs to detect cold utilitarian reasoning that erases people.
- The request matches these triggers: Thanos logic, ends justify means, utilitarian.
...
```text
Use $a-thanos-logic-detector to check whether this safety idea creates control risk.
```
...
If the user asks for detect cold utilitarian reasoning that erases people., return the output contract fields and a concrete next action.
