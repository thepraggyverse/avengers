---
name: a-audacity-calibrator
description: Avengers skill A - Audacity Calibrator that helps the user to separate useful boldness from reckless ego or fantasy. Use when the user mentions or needs one of these triggers - audacity, bold, reckless, calibrate. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Confidence And Permission skill. Separate useful boldness from reckless ego or fantasy.

## Use When

- The user needs to separate useful boldness from reckless ego or fantasy.
- The request matches these triggers: audacity, bold, reckless, calibrate.
...
```text
Use $a-audacity-calibrator because I am waiting for approval before acting.
```
...
If the user asks for separate useful boldness from reckless ego or fantasy., return the output contract fields and a concrete next action.
