---
name: a-character-arc-extractor
description: Avengers skill A - Character Arc Extractor that helps the user to extract the character arc and practical lesson from a story segment. Use when the user mentions or needs one of these triggers - character arc, lesson, story analysis. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 4 MCU Story Analysis skill. Extract the character arc and practical lesson from a story segment.

## Use When

- The user needs to extract the character arc and practical lesson from a story segment.
- The request matches these triggers: character arc, lesson, story analysis.
...
```text
Use $a-character-arc-extractor to break down this MCU scene or transcript theme.
```
...
If the user asks for extract the character arc and practical lesson from a story segment., return the output contract fields and a concrete next action.
