---
name: a-mcu-easter-egg-breakdown
description: Avengers skill A - MCU Easter Egg Breakdown that helps the user to extract callbacks, visual references, comic nods, and hidden details. Use when the user mentions or needs one of these triggers - easter eggs, breakdown, hidden details, Iron Man, Iron Man 2, MCU connections. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 4 MCU Story Analysis skill. Extract callbacks, visual references, comic nods, and hidden details.

## Use When

- The user needs to extract callbacks, visual references, comic nods, and hidden details.
- The request matches these triggers: easter eggs, breakdown, hidden details, Iron Man, Iron Man 2, MCU connections.
...
```text
Use $a-mcu-easter-egg-breakdown to break down this MCU scene or transcript theme.
```
...
If the user asks for extract callbacks, visual references, comic nods, and hidden details., return the output contract fields and a concrete next action.
