---
name: a-under-pressure-decisions
description: Avengers skill A - Under Pressure Decisions that helps the user to make a useful decision under time pressure and incomplete information. Use when the user mentions or needs one of these triggers - urgent decision, pressure, incomplete info, choose now. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 2 Problem Solving skill. Make a useful decision under time pressure and incomplete information.

## Use When

- The user needs to make a useful decision under time pressure and incomplete information.
- The request matches these triggers: urgent decision, pressure, incomplete info, choose now.
...
```text
Use $a-under-pressure-decisions on this messy situation and give me the next concrete move.
```
...
If the user asks for make a useful decision under time pressure and incomplete information., return the output contract fields and a concrete next action.
