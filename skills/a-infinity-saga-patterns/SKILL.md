---
name: a-infinity-saga-patterns
description: Avengers skill A - Infinity Saga Patterns that helps the user to analyze recurring Infinity Saga structures and payoffs. Use when the user mentions or needs one of these triggers - Infinity Saga, pattern, payoff. Also use when searching for Avengers, Tony Stark, Iron Man, MCU, A-skill, or A-prefixed operating modes.
---
...
Tier 4 MCU Story Analysis skill. Analyze recurring Infinity Saga structures and payoffs.

## Use When

- The user needs to analyze recurring Infinity Saga structures and payoffs.
- The request matches these triggers: Infinity Saga, pattern, payoff.
...
```text
Use $a-infinity-saga-patterns to break down this MCU scene or transcript theme.
```
...
If the user asks for analyze recurring infinity saga structures and payoffs., return the output contract fields and a concrete next action.
